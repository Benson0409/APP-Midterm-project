    ...
    <Center
      ...
      <Image
        ...
        <VStack space={3} >
          ...
          <Box mr={10}>
            <FontAwesome name="google-plus-circle" color="#51483C" size={40} />
          </Box>
          <Box >
            <MaterialIcons name="facebook" color="#51483C" size={40} />
          </Box>
          <Box ml={10}>
            <Entypo name="instagram-with-circle" color="#51483C" size={40} />
          </Box>
          </HStack>
      </VStack>
    </Center>
