...
const SettingsScreen = ({ navigation }) => {
  return (
    <Box _dark={{ bg: "#7888A0" }} _light={{ bg: "#FFFCF4" }} h="100%">
      <Box _dark={{ bg: "#1C3851" }} _light={{ bg: "#A1917A" }} position="absolute" w={400} h={400} borderRadius={400} shadow={8} top={-190} left={-5} >
      ...
      <ListItem
        ...
        icon="icon1"
      />
      <Divider h={0.5} w="85%" alignSelf="flex-end" _dark={{ bg: "#1C3851" }} _light={{ bg: "#A1917A" }} ></Divider>
